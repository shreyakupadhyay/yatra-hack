...
function get_message()
{
        ...
        AND (strlen($message_id) > 0))
    {
        ...
        //$reply = exec("python $PWD/get_id.py ".$message);
        $reply = shell_exec("python /home/shreyakupadhyay/Documents/yatra-hackathon/get_id.py ".$message);
     ...
     */
     send_instant_message($from,$reply);
    /**
